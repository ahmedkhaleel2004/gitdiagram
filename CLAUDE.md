...
- **Counters** (`/api/admin/state`, polled every 5 s and re-read on each relevant event): video/MP4 budgets, whether narration is paused, complimentary diagram tokens.
