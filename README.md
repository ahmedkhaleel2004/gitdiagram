...
- **Provider choice:** OpenAI by default, with OpenRouter and Requesty available for self-hosted deployments.
...
- **AI:** OpenAI, OpenRouter, or Requesty through `AI_PROVIDER`
- **Analytics:** PostHog
